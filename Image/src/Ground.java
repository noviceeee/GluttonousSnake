...
public static final int GAME_HEIGHT = 400;// 游戏窗口大小
	...
	private void play(Graphics g) {//游戏运行
		...
		g.drawString("length:" + snake.bodies.size(), 10, 75);//显示蛇的长度
	...
	private void gameOver(Graphics g) {//游戏结束
		...
		g.drawString("your score: " + score, 130, 250);
		g.drawString("your length: " + snake.bodies.size(), 130, 280);
